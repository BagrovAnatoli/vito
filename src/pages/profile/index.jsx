            ...
            <div className={classes.wrapper}>
                <div className={classes.container}>
                    <Header>
                        ...
                        : (
                            <>
                                <HeaderButton className={classes['header__btn-putAd']} id="btputAd" onClick={createAdHandler}>
                        ...
                        <div className={classes.main__container}>
                            <div className={classes['main__center-block']}>
                                ...
                                : (
                                    <div className={`${classes.main__profile} ${classes.profile}`}>
                                        <div className={classes.profile__content}>
                                            Войдите или зарегистрируйтесь, чтобы пользоваться всеми возможностями сервиса
                                        </div>
                                    </div>
                                )}
